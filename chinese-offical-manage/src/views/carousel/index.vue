<template>
  <div class="app-container">
    <div class="addBtn">
      <el-button type="success" @click="handleCreate()">添加轮播图</el-button>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column label="图片" width="320" align="center">
        <template slot-scope="scope">
          <img class="imgWH" :src="scope.row.bannerUrl+ scope.row.bannerPath" />
        </template>
      </el-table-column>

      <el-table-column label="描述" align="center">
        <template slot-scope="scope">{{ scope.row.bannerContent }}</template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="图片" prop="bannerUrl">
          ...
          <img v-if="!disableBool" class="imgWH" :src="temp.bannerUrl+temp.bannerPath" />
        </el-form-item>
...
<script>
import { getList, create, del, upd, detail } from "@/api/carousel";
