    ...
    >
      ...
      <el-table-column align="center" prop="created_at" label="操作" width="300">
       <template slot-scope="scope">
              ...
              <el-button  v-if="currentStatus==1" type="success" size="mini" @click="fetchTwoData(scope.row)">
                二级栏目
              </el-button>
      ...
      <el-form ref="dataForm"     :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="等级" prop="level">
          <el-select v-model="temp.level" disabled class="filter-item" placeholder="请选择" >
            <el-option v-for="item in levelList" :key="item.key" :label="item.display_name" :value="item.key" />
          </el-select>
        </el-form-item>
  ...
  data() {
    return {
      ...
      dialogStatus: '',
       ...
       rules: {
        channelName: [{ required: true, message: '名称是必填的', trigger: 'blur' }],
